...
startButton.addEventListener("click", () => {
    ...
    if (input== null){
        ...
        document.body.innerHTML = "<div class='wrapper'><h2 class='question'> TALA! Do you love me?</h2>"+
...
function yesButtonListener(){
    document.body.innerHTML = "<div class='wrapper'><h2 class='question'>Yay! i Knew it  ❤️, !</h2>"+
...
function noButtonListener(){
    if (count < 5) {
        ...
        questionMain.innerHTML = "JUST AWNSER IT, ILL LET YOU WHIP ME 😛?!";
    }
